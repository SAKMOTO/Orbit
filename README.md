<p align="center">
  <img src="docs/images/logo.png" alt="Orbit Orbit - AI Android Automation" width="120" height="120">
</p>
...
这让Orbit可以直接在手机上执行截图、点击、输入等操作，真正实现「一个 App 搞定一切」。

### 类 Claude Code 的 Tools/Skills 双层架构

受 [Claude Code](https://claude.ai/claude-code) 架构启发，Orbit实现了 **Tools + Skills 双层 Agent 框架**：
...
当 Shizuku 以 Root 权限运行时，Orbit可以启用 Root 模式：
